!(function (t, e) {
  ...
  function l(t) {
    return t
      ? (0, u.getStyle)(t, "fontSize") || l(t.parentElement)
      : (0, u.getStyle)(window.document.documentElement, "fontSize");
  }
  function s(t, e) {
    t.classList.add(e);
  }
  ...
  i = o.pixels = function t(e, n) {
    var r,
      ...
      s = (function (t) {
        ...
        return [
          r,
          (null !== (e = null == o ? void 0 : o[1]) && void 0 !== e
            ? e
            : ""
          ).toLowerCase(),
        ];
    ...
    switch (s[1]) {
      ...
      case "vmin":
        return (
          (f *
            Math.min(
              i.innerWidth || u.clientWidth,
              i.innerHeight || u.clientHeight
            )) /
          100
        );
      case "vmax":
    ...
    return {
      ...
      activate: function (t) {
        ...
        n.setAttribute("aria-expanded", "true"),
          ...
          (e = o),
          (H = Math.round(i(r(e, "maxHeight"), e))),
          null == t || t(a, n);
      },
      dismiss: function (t) {
      ...
      reposition: function () {
        E(a) &&
          ...
          a.offsetHeight < o.scrollHeight
            ? (s(a, w), o.setAttribute("tabindex", "0"))
            : (f(a, w), o.removeAttribute("tabindex")));
      },
      resize: function () {
        E(a) &&
          ((a.style.left =
            (function (t, e) {
              var n = t.offsetWidth;
              return (
                -h(e) * n + parseInt(r(e, "marginLeft"), 10) + e.offsetWidth / 2
              );
            })(o, n) + "px"),
          (c.style.maxWidth = o.offsetWidth + "px"),
          (function (t, e) {
  ...
  function k(t, e) {
    ...
    (d(t), n !== e) &&
      (n.innerHTML.replace("[]", "").replace("&nbsp;", " ").trim() || k(n, e));
  }
  function I(t, e) {
    var n = t[0],
      r = t[1],
  ...
  function F(t, e) {
    ...
    return function (t) {
      ...
      a.setAttribute("aria-expanded", "false"),
        (a.dataset.footnoteButton = ""),
        (a.dataset.footnoteId = i);
      var c = j(r(o));
      ...
      return (
        ...
        { id: i, button: a, host: u, popover: c, content: s, wrapper: l }
      );
    };
  }
  function B(t) {
  ...
  var V = {
    ...
    contentTemplate:
      '<aside class="littlefoot__popover" id="fncontent:<% id %>"><div class="'
        .concat(M, '"><div class="')
        .concat(_, '"><% content %></div></div><div class="')
        .concat(v, '"></div></aside>'),
    buttonTemplate:
    ...
    var n = e(e({}, V), t),
      r = (function (t, e) {
          ...
          i = function (t) {
            return function (r) {
              e.allowMultiple ||
                ...
                r.isReady() &&
                  (r.activate(e.activateCallback),
                  r.reposition(),
                  r.resize(),
                  setTimeout(r.ready, t));
            };
          },
          u = function (t) {
            return function (e) {
        ...
        return {
          ...
          hover: u(function (t) {
            t.startHovering(),
              e.activateOnHover && !t.isActive() && i(e.hoverDelay)(t);
          }),
